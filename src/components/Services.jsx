...
const rooms = [
  {
    ...
    bed: 'Single AC Room',
    size: '200 sq ft',
    image: 'https://ik.imagekit.io/zhrq3zl7w/Single%20AC%20room.jpg',
  ...
  },
{
    ...
    description: 'Perfect for family . Air-conditioned room with flat-screen TV, private bathroom, and a balcony view.',
    amenities: ['Air Conditioning', 'Flat-Screen TV', 'Private Bathroom', 'Free Wi-Fi', 'Free Parking', 'Toiletries', 'Bottled Water', 'Balcony'],
    tag: 'Most Popular',
  },
{
    ...
    bed: 'Single Bed',
    size: '200 sq ft',
    image: 'https://ik.imagekit.io/zhrq3zl7w/WhatsApp%20Image%202026-04-08%20at%206.10.34%20PM.jpeg',
    description: 'Perfect for couples or solo travelers. Air-conditioned room with flat-screen TV, private bathroom, and a balcony view.',
    amenities: ['Flat-Screen TV', 'Private Bathroom', 'Free Wi-Fi', 'Free Parking', 'Toiletries', 'Bottled Water', 'Balcony'],
    tag: 'Most Popular',
  },
  ...
  
  {
    ...
    amenities: [ 'Flat-Screen TV', 'Bathtub & Shower', 'Free Wi-Fi', 'Free Parking', 'Toiletries', 'Bottled Water', 'Terrace'],
